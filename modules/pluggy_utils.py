"""
Pluggy utilities implementation.

This module contains the Pluggy integration helpers used by the application
and unit tests. It was previously available as `modules.pluggy_utils`.
"""
